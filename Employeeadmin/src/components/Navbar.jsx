...
const Navbar = () => {
  const { login, setlogin, setUpdateid } = useContext(UserContext);
      ...
      <div className="flex items-center space-x-4">
        {login ? (
          <>
            ...
            <button  className="px-4 py-2 rounded-md bg-gray-800 hover:bg-gray-700 text-sm font-medium" onClick={handleLogout}>Logout</button>
          </>
        ) : (
          <>
            <Link
